...
pub fn verify_ml_dsa(
    ...
    let pk =
        ml_dsa_65::PublicKey::try_from_bytes(pk_arr).map_err(|_| SigningError::InvalidPublicKey)?;
...
mod ts_cross {
    ...
    fn rust_verifies_ts_produced_ml_dsa_signature() {
        ...
        let ts_sig: Vec<u8> = (0..6618)
            .step_by(2)
            .map(|i| u8::from_str_radix(&TS_SIG_HEX[i..i + 2], 16).unwrap())
            .collect();
        assert!(
            verify_ml_dsa(&pk, &msg, &ts_sig).is_ok(),
...
mod ts_hybrid_cross {
    use super::*;
    /// Proves the node's Hybrid auth arm accepts a TS-produced hybrid signature:
    /// split ed25519[64] ‖ ml_dsa, verify each half (exactly what verify_auth does).
    #[test]
    fn rust_verifies_ts_produced_hybrid_signature() {
        use solen_types::transaction::{Action, UserOperation};
        let op = UserOperation {
            sender: [1u8; 32],
            nonce: 42,
        ...
        let msg = op.signing_message(1337);
        let ed_pk = crate::Keypair::from_seed(&[8u8; 32]).public_key(); // TS ed seed
        let ml_pk = MlDsaKeypair::from_seed(&[7u8; 32]).public_key(); // TS ml seed
        let sig: Vec<u8> = (0..6746)
            .step_by(2)
            .map(|i| u8::from_str_radix(&TS_HYBRID_HEX[i..i + 2], 16).unwrap())
            .collect();
        assert_eq!(sig.len(), 64 + ML_DSA_SIG_LEN);
        let mut ed = [0u8; 64];
        ed.copy_from_slice(&sig[..64]);
        assert!(
            crate::verify(&ed_pk, &msg, &ed).is_ok(),
            "ed25519 half (TS->Rust) must verify"
        );
        assert!(
            verify_ml_dsa(&ml_pk, &msg, &sig[64..]).is_ok(),
            "ml-dsa half (TS->Rust) must verify"
        );
    }
    const TS_HYBRID_HEX: &str = "";
}
